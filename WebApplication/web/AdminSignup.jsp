<%-- 
    ...
    Created on : Aug 2, 2022, 7:47:22 PM
    Author     : hp
--%>
...
<body>
    ...
    <!-- signup form  -->
    <!-- ============================================================== -->
    <form  action = "Register" method = "" class="splash-container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                     Male
                     <input class="form-check-input" type="radio" name="gender" value="male" required="" placeholder="Male" >
                     Female
                      <input class="form-check-input " type="radio" name="gender" value="female" required="" placeholder="Female" >
                </div>
